...
#for showing signup/login button for teacher(by Rushikesh)
...
#for showing signup/login button for student(by Rushikesh)
...
#for checking user is techer , student or admin(by Rushikesh)
def is_admin(user):
...
#for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Rushikesh)
...
def admin_dashboard_view(request):
    ...
    #aggregate function return dictionary so fetch data from dictionay(by Rushikesh)
    mydict={
...
#for teacher sectionnnnnnnn by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Rushikesh)
...
#for student by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Rushikesh)
...
#attendance related viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(by Rushikesh)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#fee related view by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Rushikesh)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#notice related viewsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss(by Rushikesh)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN(by Rushikesh)
...
#FOR STUDENT AFTER THEIR Loginnnnnnnnnnnnnnnnnnnnn(by Rushikesh)
...
# for aboutus and contact ussssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss (by Rushikesh)
